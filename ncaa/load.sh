...
psql softball -f schema/create_schema_ncaa.sql

tail -q -n+2 csv/ncaa_games_mt_*.csv >> /tmp/games.csv
psql softball -f loaders/load_ncaa_games.sql
rm /tmp/games.csv
