...
cmd="psql template1 --tuples-only --command \"select count(*) from pg_database where datname = 'softball';\""

db_exists=`eval $cmd`
 
if [ $db_exists -eq 0 ] ; then
   cmd="createdb softball"
   eval $cmd
fi
...
psql softball -f schema/create_schema.sql
...
psql softball -f loaders/load_years.sql
rm /tmp/years.csv
...
psql softball -f loaders/load_years_divisions.sql
...
psql softball -f loaders/load_teams.sql
rm /tmp/teams.csv
...
psql softball -f loaders/load_schedules.sql
...
rpl -e '\t-\t' '\t\t' /tmp/rosters.csv
psql softball -f loaders/load_rosters.sql
rm /tmp/rosters.csv
...
psql softball -f loaders/load_box_scores_hitting.sql
...
psql softball -f loaders/load_box_scores_hitting_2014-2016.sql
rm /tmp/box_scores.csv
rm /tmp/ncaa_box_scores_hitting_*.csv
...
psql softball -f loaders/load_box_scores_hitting_2013.sql
rm /tmp/box_scores.csv
rm /tmp/ncaa_box_scores_hitting_*.csv
...
gzip -d /tmp/ncaa_box_scores_hitting_*.csv.gz
tail -q -n+2 /tmp/ncaa_box_scores_hitting_*.csv >> /tmp/box_scores.csv
psql softball -f loaders/load_box_scores_hitting_2012.sql
rm /tmp/box_scores.csv
rm /tmp/ncaa_box_scores_hitting_*.csv
...
psql softball -f loaders/load_box_scores_pitching.sql
rm /tmp/box_scores.csv
...
tail -q -n+2 /tmp/ncaa_box_scores_pitching_*_?.csv >> /tmp/box_scores.csv
rpl -q '""' '' /tmp/box_scores.csv
psql softball -f loaders/load_box_scores_pitching_2016.sql
rm /tmp/box_scores.csv
rm /tmp/ncaa_box_scores_pitching_*_?.csv
...
psql softball -f loaders/load_box_scores_pitching_2012-2015.sql
rm /tmp/box_scores.csv
...
gzip -d /tmp/ncaa_box_scores_fielding_*.csv.gz
tail -q -n+2 /tmp/ncaa_box_scores_fielding_*.csv >> /tmp/box_scores.csv
psql softball -f loaders/load_box_scores_fielding_2012-2013.sql
rm /tmp/box_scores.csv
rm /tmp/ncaa_box_scores_fielding_*.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_hitting_2015.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_hitting_2014.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_pitching.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_pitching_2016.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_pitching_2015.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_pitching_2012-2014.sql
rm /tmp/player_summaries.csv
...
rpl -q '""' '' /tmp/player_summaries.csv
rpl -q ' ' '' /tmp/player_summaries.csv
psql softball -f loaders/load_player_summaries_fielding_2014-2016.sql
rm /tmp/player_summaries.csv
...
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_hitting.sql
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_hitting_2015.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_hitting_2014.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_hitting_2013.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_hitting_2012.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_pitching.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_pitching_2016.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_pitching_2015.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_pitching_2012-2014.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_fielding.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_fielding_2014-2016.sql
rm /tmp/team_summaries.csv
...
rpl -q '""' '' /tmp/team_summaries.csv
rpl -q ' ' '' /tmp/team_summaries.csv
psql softball -f loaders/load_team_summaries_fielding_2012-2013.sql
rm /tmp/team_summaries.csv
...
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_hitting_splits.sql
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_hitting_splits_2015.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_hitting_splits_2014.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_hitting_splits_2013.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_hitting_splits_2012.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_pitching_splits.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_pitching_splits_2015.sql
rm /tmp/player_summaries_splits.csv
...
rpl -q '""' '' /tmp/player_summaries_splits.csv
rpl -q ' ' '' /tmp/player_summaries_splits.csv
psql softball -f loaders/load_player_summaries_pitching_splits_2012-2014.sql
rm /tmp/player_summaries_splits.csv
...
psql softball -f cleaning/commas_psp.sql
psql softball -f cleaning/commas_tsh.sql
psql softball -f cleaning/commas_tsp.sql
psql softball -f cleaning/commas_tsf.sql
...
psql softball -f loaders/load_play_by_play.sql
rm /tmp/play_by_play.csv
rm /tmp/ncaa_games_play_by_play_*.csv

# Vacuum schema ncaa_pbp

echo "Vacuuming softball schema ncaa_pbp"
psql -t -A -c "select 'VACUUM '||table_schema||'.'||table_name||';' from information_schema.tables where table_schema = 'ncaa_pbp'" softball | psql softball
...
psql softball -f cleaning/denull_bsp.sql
...
psql softball -f cleaning/deduplicate_periods.sql
psql softball -c "vacuum ncaa_pbp.periods;"

psql softball -f cleaning/deduplicate_pbp.sql
psql softball -c "vacuum ncaa_pbp.play_by_play;"

psql softball -f cleaning/deduplicate_bsh.sql
psql softball -c "vacuum ncaa_pbp.box_scores_hitting;"

psql softball -f cleaning/deduplicate_bsp.sql
psql softball -c "vacuum ncaa_pbp.box_scores_pitching;"

psql softball -f cleaning/deduplicate_bsf.sql
psql softball -c "vacuum ncaa_pbp.box_scores_fielding;"
...
psql softball -f cleaning/add_pk_periods.sql
psql softball -f cleaning/add_pk_pbp.sql
psql softball -f cleaning/add_pk_bsh.sql
psql softball -f cleaning/add_pk_bsp.sql
psql softball -f cleaning/add_pk_bsf.sql
...
psql softball -f loaders/create_pitch_strings.sql
