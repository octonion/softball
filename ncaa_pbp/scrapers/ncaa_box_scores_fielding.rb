...
ncaa_games_box_scores = CSV.open("csv/ncaa_box_scores_fielding_#{year}_#{division}.csv", "w", {:col_sep => "\t"})

# Headers

#Player 	Pos 	G 	PO 	A 	E 	CI 	PB 	SBA 	CSB 	IDP 	TP

box_scores_header = [
"game_id", "section_id", "player_id", "player_name", "player_url",
"starter", "position", "g", "po", "a", "e", "ci", "pb", "sba", "csb",
"idp", "tp"]
