...
ncaa_games_box_scores = CSV.open("csv/ncaa_box_scores_pitching_#{year}_#{division}.csv", "w", {:col_sep => "\t"})

# Headers

#Player 	Pos 	App 	GS 	IP 	H 	R 	ER 	BB 	SO 	SHO 	BF 	P-OAB 	2B-A 	3B-A 	HR-A 	WP 	Bk 	HB 	IBB 	Inh Run 	Inh Run Score 	SHA 	SFA 	Pitches 	GO 	FO 	W 	L 	SV 	OrdAppeared 	KL
