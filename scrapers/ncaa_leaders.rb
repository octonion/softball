...
first_year = 2014
last_year = 2014
#url = "http://www.ncaa.com/stats/softball/d1"
base = "http://web1.ncaa.org/stats/StatsSrv/rankings"
#?sportCode=WSB&div=1&rptWeeks=17&category=individual&statSeq=504&rptType=CSV&academicYear=2011&doWhat=showrankings
...
#        url = "#{base}?sportCode=WSB&div=#{div}&rptWeeks=8&category=individual&statSeq=#{stat}&rptType=CSV&academicYear=#{year}&doWhat=showrankings"
        url = "#{base}?sportCode=WSB&div=#{div}&category=individual&statSeq=#{stat}&rptType=CSV&academicYear=#{year}&doWhat=showrankings"
